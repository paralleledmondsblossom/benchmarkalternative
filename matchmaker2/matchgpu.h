...
__global__ void gaSelect_depth0(int *match, int *dkeepMatching, int * S_d, const int nrVertices, const uint random);
...
__global__ void grRequestEdgeList(int * rmatch, int * cmatch, int *requests, const int *match, int *c,const int nrVertices);
